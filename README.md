...
``` 
  ...
  - 예측한 2022년 1월 도축두수와 2022년 2월 도축두수의 실제 데이터와 비교해 `score = |1 - 예측 도축두수 / 실제 도축두수| * 100`을 구합니다. 이를 그래프로 표현합니다.   
![예측_도축량과_실제_도축량_오차율](https://user-images.githubusercontent.com/86904141/218388120-d81922d8-4048-49e2-8be9-bb10a9cc2b01.png)   
> 1월은 오차가 20%이내로 비교적 안정적이였지만, 2월은 80프로로 매우 커져 예측이 진행되지않았다.   

**예측에 사용한 도축율 자체가 오차범위가 굉장히 큰 문제를 가지고 있고, 1월에 적용된 오차가 2월에 다시 한번 적용되며 오차율이 매우 커진 것으로 보인다.**   
